...
class CenterAlignPlugin {
  ...
  static apis = ['centerL', 'center', 'position', 'centerV'];
  ...
  centerL(workspace: fabric.Rect, object: fabric.Object) {
    return this.canvas._centerObject(
      object,
  ...
  position(name: 'centerL' | 'center' | 'centerV') {
    const anignType = ['centerL', 'center', 'centerV'];
