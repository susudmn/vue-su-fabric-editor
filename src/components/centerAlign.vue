...
<template>
    <div v-if="mixinState.mSelectMode" class="box attr-item">
        ...
        <Tooltip :content="$t('center_align.centerX')">
            <Button :disabled="!mixinState.mSelectMode" @click="position('centerL')" type="text">
                <svg t="1650442559691" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="3787" width="14" height="14">
        ...
        <Tooltip :content="$t('center_align.center')">
            <Button :disabled="!mixinState.mSelectMode" @click="position('center')" type="text">
                <svg t="1650852784867" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="2351" width="14" height="14">
        ...
        <Tooltip :content="$t('center_align.centerY')">
            <Button :disabled="!mixinState.mSelectMode" @click="position('centerV')" type="text">
                <svg t="1650442510967" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                    p-id="3412" width="14" height="14">
                    <path
