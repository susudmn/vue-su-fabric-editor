        ...
        <Collapse>
            ...
            <Panel name="2">
                ...
                <template #content>
                    <!-- 有参数滤镜与组合参数滤镜 -->
                    <div>
                        <div class="filter-item has-params"
                            v-for="item in [...state.paramsFilters, ...state.combinationFilters]" :key="item.type">
                            ...
                            <div v-if="item.status" class="content">
                                <div class="content slider-box" v-for="info in item.params" :key="info">
                                    ...
                                    <div v-if="info.uiType === uiType.COLOR">
                                        <ColorPicker v-model="info.value" alpha size="small"
